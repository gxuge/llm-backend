...
from src.app.schemas.exam_agent import TableSpec
from src.agents.nodes.state import AgentState
from src.agents.nodes.utils import build_table_from_rows, find_candidates
from src.agents.services.events import emit_event


def viz_builder(state: AgentState) -> AgentState:
    """将工具结果组装为 Table/Chart，并输出 viz.* 事件。"""
